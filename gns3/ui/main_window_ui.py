...
_ICONS_DIR = _os.path.join(_os.path.dirname(_os.path.dirname(_os.path.dirname(_os.path.abspath(__file__)))), "resources", "icons")

def _icon_path(resource_path):
    """Prefer on-disk icon over embedded resource."""
    filename = resource_path.rsplit("/", 1)[-1]
    disk = _os.path.join(_ICONS_DIR, filename)
...
"")
        ...
        self.uiGraphicsView = GraphicsView(parent=self.uiCentralWidget)
        ...
        self.uiMenuBar = QtWidgets.QMenuBar(parent=MainWindow)
        self.uiMenuBar.setGeometry(QtCore.QRect(0, 0, 986, 22))
        self.uiMenuBar.setObjectName("uiMenuBar")
        self.uiEditMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiEditMenu.setObjectName("uiEditMenu")
        self.uiFileMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiFileMenu.setObjectName("uiFileMenu")
        self.uiHelpMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiHelpMenu.setObjectName("uiHelpMenu")
        self.uiViewMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiViewMenu.setObjectName("uiViewMenu")
        self.uiDocksMenu = QtWidgets.QMenu(parent=self.uiViewMenu)
        self.uiDocksMenu.setObjectName("uiDocksMenu")
        self.uiControlMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiControlMenu.setObjectName("uiControlMenu")
        self.uiAnnotateMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiAnnotateMenu.setObjectName("uiAnnotateMenu")
        self.uiDeviceMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiDeviceMenu.setObjectName("uiDeviceMenu")
        self.uiToolsMenu = QtWidgets.QMenu(parent=self.uiMenuBar)
        self.uiToolsMenu.setObjectName("uiToolsMenu")
        MainWindow.setMenuBar(self.uiMenuBar)
        self.uiStatusBar = StatusBar(parent=MainWindow)
        self.uiStatusBar.setObjectName("uiStatusBar")
        MainWindow.setStatusBar(self.uiStatusBar)
        self.uiGeneralToolBar = QtWidgets.QToolBar(parent=MainWindow)
        self.uiGeneralToolBar.setToolTip("")
        self.uiGeneralToolBar.setStatusTip("")
        self.uiGeneralToolBar.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.uiGeneralToolBar.setIconSize(QtCore.QSize(32, 32))
        self.uiGeneralToolBar.setObjectName("uiGeneralToolBar")
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.uiGeneralToolBar)
        self.uiNodesDockWidget = NodesDockWidget(parent=MainWindow)
        self.uiNodesDockWidget.setEnabled(True)
        self.uiNodesDockWidget.setVisible(True)
        self.uiNodesDockWidget.setFloating(False)
        self.uiNodesDockWidget.setAllowedAreas(QtCore.Qt.DockWidgetArea.LeftDockWidgetArea|QtCore.Qt.DockWidgetArea.RightDockWidgetArea)
        ...
        self.uiNodesFilterLineEdit = QtWidgets.QLineEdit(parent=self.uiNodesDockWidgetContents)
        self.uiNodesFilterLineEdit.setObjectName("uiNodesFilterLineEdit")
        self.vboxlayout.addWidget(self.uiNodesFilterLineEdit)
        self.uiNodesView = NodesView(parent=self.uiNodesDockWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.uiNewTemplatePushButton = QtWidgets.QPushButton(parent=self.uiNodesDockWidgetContents)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_icon_path(":/icons/plus.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.uiBrowsersToolBar = QtWidgets.QToolBar(parent=MainWindow)
        self.uiBrowsersToolBar.setIconSize(QtCore.QSize(48, 48))
        self.uiBrowsersToolBar.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.uiBrowsersToolBar.setObjectName("uiBrowsersToolBar")
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.LeftToolBarArea, self.uiBrowsersToolBar)
        self.uiControlToolBar = QtWidgets.QToolBar(parent=MainWindow)
        self.uiControlToolBar.setIconSize(QtCore.QSize(32, 32))
        self.uiControlToolBar.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.uiControlToolBar.setObjectName("uiControlToolBar")
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.uiControlToolBar)
        self.uiConsoleDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        self.uiConsoleDockWidget.setMaximumSize(QtCore.QSize(524287, 524287))
        self.uiConsoleDockWidget.setAllowedAreas(QtCore.Qt.DockWidgetArea.AllDockWidgetAreas)
        ...
        self.uiConsoleTextEdit = ConsoleView(parent=self.uiConsoleDockWidgetContents)
        ...
        self.uiAnnotationToolBar = QtWidgets.QToolBar(parent=MainWindow)
        self.uiAnnotationToolBar.setIconSize(QtCore.QSize(32, 32))
        self.uiAnnotationToolBar.setObjectName("uiAnnotationToolBar")
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.uiAnnotationToolBar)
        self.uiTopologySummaryDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.uiTopologySummaryDockWidget.setAllowedAreas(QtCore.Qt.DockWidgetArea.AllDockWidgetAreas)
        ...
        self.uiTopologySummaryTreeWidget = TopologySummaryView(parent=self.uiTopologySummaryDockWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.uiComputeSummaryDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        self.uiComputeSummaryDockWidget.setAllowedAreas(QtCore.Qt.DockWidgetArea.AllDockWidgetAreas)
        ...
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.uiComputeSummaryTreeWidget = ComputeSummaryView(parent=self.dockWidgetContents)
        ...
        self.uiAboutAction = QtGui.QAction(parent=MainWindow)
        self.uiAboutAction.setMenuRole(QtGui.QAction.MenuRole.AboutRole)
        self.uiAboutAction.setObjectName("uiAboutAction")
        self.uiQuitAction = QtGui.QAction(parent=MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_icon_path(":/icons/quit.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiQuitAction.setIcon(icon1)
        self.uiQuitAction.setObjectName("uiQuitAction")
        self.uiOpenProjectAction = QtGui.QAction(parent=MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_icon_path(":/icons/open.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiOpenProjectAction.setIcon(icon2)
        self.uiOpenProjectAction.setObjectName("uiOpenProjectAction")
        self.uiOnlineHelpAction = QtGui.QAction(parent=MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_icon_path(":/icons/help.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiOnlineHelpAction.setIcon(icon3)
        self.uiOnlineHelpAction.setObjectName("uiOnlineHelpAction")
        self.uiScreenshotAction = QtGui.QAction(parent=MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_icon_path(":/icons/camera-photo.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon4.addPixmap(QtGui.QPixmap(_icon_path(":/icons/camera-photo-hover.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiScreenshotAction.setIcon(icon4)
        self.uiScreenshotAction.setObjectName("uiScreenshotAction")
        self.uiStartAllAction = QtGui.QAction(parent=MainWindow)
        self.uiStartAllAction.setEnabled(True)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_icon_path(":/icons/start.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon5.addPixmap(QtGui.QPixmap(_icon_path(":/icons/start-hover.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiStartAllAction.setIcon(icon5)
        self.uiStartAllAction.setObjectName("uiStartAllAction")
        self.uiStopAllAction = QtGui.QAction(parent=MainWindow)
        self.uiStopAllAction.setEnabled(True)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_icon_path(":/icons/stop.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon6.addPixmap(QtGui.QPixmap(_icon_path(":/icons/stop-hover.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiStopAllAction.setIcon(icon6)
        self.uiStopAllAction.setObjectName("uiStopAllAction")
        self.uiConsoleAllAction = QtGui.QAction(parent=MainWindow)
        self.uiConsoleAllAction.setEnabled(True)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_icon_path(":/icons/console.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiConsoleAllAction.setIcon(icon7)
        self.uiConsoleAllAction.setObjectName("uiConsoleAllAction")
        self.uiAboutQtAction = QtGui.QAction(parent=MainWindow)
        self.uiAboutQtAction.setMenuRole(QtGui.QAction.MenuRole.AboutQtRole)
        self.uiAboutQtAction.setObjectName("uiAboutQtAction")
        self.uiZoomInAction = QtGui.QAction(parent=MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_icon_path(":/icons/zoom-in.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon8.addPixmap(QtGui.QPixmap(_icon_path(":/icons/zoom-in-hover.png")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiZoomInAction.setIcon(icon8)
        self.uiZoomInAction.setObjectName("uiZoomInAction")
        self.uiZoomOutAction = QtGui.QAction(parent=MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_icon_path(":/icons/zoom-out.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon9.addPixmap(QtGui.QPixmap(_icon_path(":/icons/zoom-out-hover.png")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiZoomOutAction.setIcon(icon9)
        self.uiZoomOutAction.setObjectName("uiZoomOutAction")
        self.uiZoomResetAction = QtGui.QAction(parent=MainWindow)
        self.uiZoomResetAction.setObjectName("uiZoomResetAction")
        self.uiSelectAllAction = QtGui.QAction(parent=MainWindow)
        self.uiSelectAllAction.setObjectName("uiSelectAllAction")
        self.uiSelectNoneAction = QtGui.QAction(parent=MainWindow)
        self.uiSelectNoneAction.setObjectName("uiSelectNoneAction")
        self.uiPreferencesAction = QtGui.QAction(parent=MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_icon_path(":/icons/applications.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiPreferencesAction.setIcon(icon10)
        self.uiPreferencesAction.setMenuRole(QtGui.QAction.MenuRole.PreferencesRole)
        self.uiPreferencesAction.setObjectName("uiPreferencesAction")
        self.uiSuspendAllAction = QtGui.QAction(parent=MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_icon_path(":/icons/pause.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon11.addPixmap(QtGui.QPixmap(_icon_path(":/icons/pause-hover.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiSuspendAllAction.setIcon(icon11)
        self.uiSuspendAllAction.setObjectName("uiSuspendAllAction")
        self.uiAddNoteAction = QtGui.QAction(parent=MainWindow)
        self.uiAddNoteAction.setCheckable(True)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_icon_path(":/icons/add-note.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiAddNoteAction.setIcon(icon12)
        self.uiAddNoteAction.setObjectName("uiAddNoteAction")
        self.uiNewProjectAction = QtGui.QAction(parent=MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_icon_path(":/icons/new-project.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiNewProjectAction.setIcon(icon13)
        self.uiNewProjectAction.setObjectName("uiNewProjectAction")
        self.uiImportExportConfigsAction = QtGui.QAction(parent=MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_icon_path(":/icons/import_export_configs.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.uiInsertImageAction = QtGui.QAction(parent=MainWindow)
        self.uiInsertImageAction.setCheckable(False)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_icon_path(":/icons/image.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiInsertImageAction.setIcon(icon15)
        self.uiInsertImageAction.setObjectName("uiInsertImageAction")
        self.uiDrawRectangleAction = QtGui.QAction(parent=MainWindow)
        self.uiDrawRectangleAction.setCheckable(True)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_icon_path(":/icons/rectangle.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon16.addPixmap(QtGui.QPixmap(_icon_path(":/icons/rectangle-hover.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiDrawRectangleAction.setIcon(icon16)
        self.uiDrawRectangleAction.setObjectName("uiDrawRectangleAction")
        self.uiDrawEllipseAction = QtGui.QAction(parent=MainWindow)
        self.uiDrawEllipseAction.setCheckable(True)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_icon_path(":/icons/ellipse.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon17.addPixmap(QtGui.QPixmap(_icon_path(":/icons/ellipse-hover.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiDrawEllipseAction.setIcon(icon17)
        self.uiDrawEllipseAction.setObjectName("uiDrawEllipseAction")
        self.uiShowPortNamesAction = QtGui.QAction(parent=MainWindow)
        self.uiShowPortNamesAction.setCheckable(True)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_icon_path(":/icons/show-interface-names.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiShowPortNamesAction.setIcon(icon18)
        self.uiShowPortNamesAction.setObjectName("uiShowPortNamesAction")
        self.uiSnapshotAction = QtGui.QAction(parent=MainWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(_icon_path(":/icons/snapshot.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiSnapshotAction.setIcon(icon19)
        self.uiSnapshotAction.setObjectName("uiSnapshotAction")
        self.uiShowLayersAction = QtGui.QAction(parent=MainWindow)
        self.uiShowLayersAction.setCheckable(True)
        self.uiShowLayersAction.setObjectName("uiShowLayersAction")
        self.uiSnapToGridAction = QtGui.QAction(parent=MainWindow)
        self.uiSnapToGridAction.setCheckable(True)
        self.uiSnapToGridAction.setObjectName("uiSnapToGridAction")
        self.uiSaveProjectAsAction = QtGui.QAction(parent=MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_icon_path(":/icons/save-as-project.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiSaveProjectAsAction.setIcon(icon20)
        self.uiSaveProjectAsAction.setObjectName("uiSaveProjectAsAction")
        self.uiReloadAllAction = QtGui.QAction(parent=MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(_icon_path(":/icons/reload.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiReloadAllAction.setIcon(icon21)
        self.uiReloadAllAction.setObjectName("uiReloadAllAction")
        self.uiAuxConsoleAllAction = QtGui.QAction(parent=MainWindow)
        self.uiAuxConsoleAllAction.setEnabled(True)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(_icon_path(":/icons/aux-console.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiAuxConsoleAllAction.setIcon(icon22)
        self.uiAuxConsoleAllAction.setObjectName("uiAuxConsoleAllAction")
        self.uiResetPortLabelsAction = QtGui.QAction(parent=MainWindow)
        self.uiResetPortLabelsAction.setObjectName("uiResetPortLabelsAction")
        self.uiCheckForUpdateAction = QtGui.QAction(parent=MainWindow)
        self.uiCheckForUpdateAction.setObjectName("uiCheckForUpdateAction")
        self.uiBrowseRoutersAction = QtGui.QAction(parent=MainWindow)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(_icon_path(":/icons/router.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon23.addPixmap(QtGui.QPixmap(_icon_path(":/icons/router-hover.png")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiBrowseRoutersAction.setIcon(icon23)
        self.uiBrowseRoutersAction.setObjectName("uiBrowseRoutersAction")
        self.uiBrowseSwitchesAction = QtGui.QAction(parent=MainWindow)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(_icon_path(":/icons/switch.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon24.addPixmap(QtGui.QPixmap(_icon_path(":/icons/switch-hover.png")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiBrowseSwitchesAction.setIcon(icon24)
        self.uiBrowseSwitchesAction.setObjectName("uiBrowseSwitchesAction")
        self.uiBrowseEndDevicesAction = QtGui.QAction(parent=MainWindow)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(_icon_path(":/icons/PC.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon25.addPixmap(QtGui.QPixmap(_icon_path(":/icons/PC-hover.png")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiBrowseEndDevicesAction.setIcon(icon25)
        self.uiBrowseEndDevicesAction.setObjectName("uiBrowseEndDevicesAction")
        self.uiBrowseSecurityDevicesAction = QtGui.QAction(parent=MainWindow)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(_icon_path(":/icons/firewall.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon26.addPixmap(QtGui.QPixmap(_icon_path(":/icons/firewall-hover.png")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        ...
        self.uiBrowseAllDevicesAction = QtGui.QAction(parent=MainWindow)
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(_icon_path(":/icons/browse-all-icons.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon27.addPixmap(QtGui.QPixmap(_icon_path(":/icons/browse-all-icons-hover.png")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        self.uiBrowseAllDevicesAction.setIcon(icon27)
        self.uiBrowseAllDevicesAction.setObjectName("uiBrowseAllDevicesAction")
        self.uiAddLinkAction = QtGui.QAction(parent=MainWindow)
        self.uiAddLinkAction.setCheckable(True)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(_icon_path(":/icons/connection-new.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon28.addPixmap(QtGui.QPixmap(_icon_path(":/icons/cancel-connection.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        icon28.addPixmap(QtGui.QPixmap(_icon_path(":/icons/connection-new-hover.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        icon28.addPixmap(QtGui.QPixmap(_icon_path(":/icons/cancel-connection.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        self.uiAddLinkAction.setIcon(icon28)
        self.uiAddLinkAction.setObjectName("uiAddLinkAction")
        self.uiFitInViewAction = QtGui.QAction(parent=MainWindow)
        self.uiFitInViewAction.setObjectName("uiFitInViewAction")
        self.uiActionFullscreen = QtGui.QAction(parent=MainWindow)
        self.uiActionFullscreen.setObjectName("uiActionFullscreen")
        self.uiSetupWizard = QtGui.QAction(parent=MainWindow)
        self.uiSetupWizard.setMenuRole(QtGui.QAction.MenuRole.NoRole)
        self.uiSetupWizard.setObjectName("uiSetupWizard")
        self.uiOpenApplianceAction = QtGui.QAction(parent=MainWindow)
        self.uiOpenApplianceAction.setIcon(icon2)
        self.uiOpenApplianceAction.setObjectName("uiOpenApplianceAction")
        self.uiExportDebugInformationAction = QtGui.QAction(parent=MainWindow)
        self.uiExportDebugInformationAction.setObjectName("uiExportDebugInformationAction")
        self.uiDoctorAction = QtGui.QAction(parent=MainWindow)
        self.uiDoctorAction.setObjectName("uiDoctorAction")
        self.uiExportProjectAction = QtGui.QAction(parent=MainWindow)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(_icon_path(":/icons/export.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiExportProjectAction.setIcon(icon29)
        self.uiExportProjectAction.setObjectName("uiExportProjectAction")
        self.uiImportProjectAction = QtGui.QAction(parent=MainWindow)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(_icon_path(":/icons/import.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiImportProjectAction.setIcon(icon30)
        self.uiImportProjectAction.setObjectName("uiImportProjectAction")
        self.uiEditReadmeAction = QtGui.QAction(parent=MainWindow)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(_icon_path(":/icons/edit.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiEditReadmeAction.setIcon(icon31)
        self.uiEditReadmeAction.setObjectName("uiEditReadmeAction")
        self.uiAcademyAction = QtGui.QAction(parent=MainWindow)
        self.uiAcademyAction.setObjectName("uiAcademyAction")
        self.uiDeleteProjectAction = QtGui.QAction(parent=MainWindow)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(_icon_path(":/icons/delete.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiDeleteProjectAction.setIcon(icon32)
        self.uiDeleteProjectAction.setObjectName("uiDeleteProjectAction")
        self.uiShowGridAction = QtGui.QAction(parent=MainWindow)
        self.uiShowGridAction.setCheckable(True)
        self.uiShowGridAction.setObjectName("uiShowGridAction")
        self.uiEditProjectAction = QtGui.QAction(parent=MainWindow)
        self.uiEditProjectAction.setIcon(icon31)
        self.uiEditProjectAction.setObjectName("uiEditProjectAction")
        self.uiDrawLineAction = QtGui.QAction(parent=MainWindow)
        self.uiDrawLineAction.setCheckable(True)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(_icon_path(":/icons/vertically.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiDrawLineAction.setIcon(icon33)
        self.uiDrawLineAction.setObjectName("uiDrawLineAction")
        self.uiLockAllAction = QtGui.QAction(parent=MainWindow)
        self.uiLockAllAction.setCheckable(True)
        self.uiLockAllAction.setChecked(False)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(_icon_path(":/icons/unlock.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon34.addPixmap(QtGui.QPixmap(_icon_path(":/icons/lock.svg")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        icon34.addPixmap(QtGui.QPixmap(_icon_path(":/icons/unlock.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        icon34.addPixmap(QtGui.QPixmap(_icon_path(":/icons/lock.svg")), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        self.uiLockAllAction.setIcon(icon34)
        self.uiLockAllAction.setObjectName("uiLockAllAction")
        self.uiWebUIAction = QtGui.QAction(parent=MainWindow)
        self.uiWebUIAction.setObjectName("uiWebUIAction")
        self.uiNewTemplateAction = QtGui.QAction(parent=MainWindow)
        self.uiNewTemplateAction.setIcon(icon)
        self.uiNewTemplateAction.setObjectName("uiNewTemplateAction")
        self.uiResetDocksAction = QtGui.QAction(parent=MainWindow)
        self.uiResetDocksAction.setObjectName("uiResetDocksAction")
        self.uiResetConsoleAllAction = QtGui.QAction(parent=MainWindow)
        self.uiResetConsoleAllAction.setObjectName("uiResetConsoleAllAction")
        self.uiResetGUIStateAction = QtGui.QAction(parent=MainWindow)
        self.uiResetGUIStateAction.setObjectName("uiResetGUIStateAction")
        self.uiShortcutsAction = QtGui.QAction(parent=MainWindow)
        ...
        self.uiFileMenu.addAction(self.uiNewTemplateAction)
        self.uiFileMenu.addSeparator()
