...
def main():
    ...
    # Set application-level icon (dock icon on macOS)
    ...
    if os.path.exists(branding_logo):
        ...
        app.setWindowIcon(QtGui.QIcon(branding_logo))
    ...
    # /Applications folder check removed — allow running from any location
